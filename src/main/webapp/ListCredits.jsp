                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full">
                        ...
                        <tr>
                            ...
                            <th class="p-2 whitespace-nowrap">
                                <div class="font-semibold text-center">Loan Tax</div>
                            </th>
                            <th class="p-2 whitespace-nowrap">
...
<c:forEach items="${credits}" var="credit">
                        <tr>
                            ...
                            <td class="p-2 whitespace-nowrap">
                                <div class="text-left">${credit.client_code}</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                                <div class="text-left font-medium text-green-500">${credit.employee_registrationnbr}</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                                <div class="text-lg text-center">${credit.credit_id}</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                                <div class="text-lg text-center">${credit.agency_code}</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                                <div class="text-lg text-center">${credit.value}</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
                                <div class="text-lg text-center">${credit.loantax}</div>
                            </td>
                            <td class="p-2 whitespace-nowrap">
